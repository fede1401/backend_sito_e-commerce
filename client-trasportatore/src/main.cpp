...
//#if (DEBUG < 0)
    while (1)
    {
        ...
        for (index = 0; index < 9; index++)
        {
            ...
            if (test2[index] == "EFFETTUA REGISTRAZIONE TRASPORTATORE")
            {
            ...
            if (test2[index] == "AGGIORNA NOME DITTASPEDIZIONE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "AVVISA SPEDIZIONE EFFETTUATA")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "PRENDI IN CARICO SPEDIZIONE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "EFFETTUA LOGIN TRASPORTATORE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "EFFETTUA LOGOUT TRASPORTATORE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "ELIMINA PROFILO TRASPORTATORE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "AGGIORNA NUMERO TELEFONO TRASPORTATORE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
            ...
            if (test2[index] == "AGGIORNA PASSWORD TRASPORTATORE")
            {
                // Impostazioni chiavi e valori per il comando Redis:
