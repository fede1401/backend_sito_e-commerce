...
int main()
{
    ...
    while (1)
    {
        ...
        int i9 = rand() % 9;
        std::string azioneFornitore = azioniFornitore[i9];
        ...
        sprintf(key1, "Action");
        sprintf(value1, azioneFornitore.c_str());

        if (azioneFornitore == "EFFETTUA REGISTRAZIONE FORNITORE")
        {
        ...
        if (azioneFornitore == "AGGIORNA NOME AZIENDAPRODUZIONE")
        {
            // Impostazioni chiavi e valori per il comando Redis:
        ...
        if (azioneFornitore == "AGGIUNGI PRODOTTO SITO")
        {
            // Impostazioni chiavi e valori per il comando Redis:
        ...
        if (azioneFornitore == "RIMUOVI PRODOTTO SITO")
        {
            // Impostazioni chiavi e valori per il comando Redis:
        ...
        if (azioneFornitore == "EFFETTUA LOGIN FORNITORE")
        {
            // Impostazioni chiavi e valori per il comando Redis:
        ...
        if (azioneFornitore == "EFFETTUA LOGOUT FORNITORE")
        {
        ...
        if (azioneFornitore == "ELIMINA PROFILO FORNITORE")
        {
        ...
        if (azioneFornitore == "AGGIORNA NUMERO TELEFONO FORNITORE")
        {
            // Impostazioni chiavi e valori per il comando Redis:
        ...
        if (azioneFornitore == "AGGIORNA PASSWORD FORNITORE")
        {
            // Impostazioni chiavi e valori per il comando Redis:
